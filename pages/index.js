          ...
          <div className='container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48'>
            <div className='flex flex-col items-center justify-center lg:flex-row'>
              <div className='rounded-full border-8 border-primary shadow-xl'>
                <img
                  src={builder.image(profile[0].profileimage).url()}
              ...
              <div className='pt-8 sm:pt-10 lg:pl-8 lg:pt-0'>
                ...
                <div className='flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start'>
                  ...
                  <div className='flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0'>
                    <a href={profile[0].facebooklink}>
                      <i className='bx bxl-facebook-square text-2xl text-white hover:text-yellow'></i>
                    </a>
                    <a href={profile[0].twitterlink}
                    className='pl-4'>
                    ...
                    <a href={profile[0].linkdinlink} className='pl-4'>
                      <i className='bx bxl-linkedin text-2xl text-white hover:text-yellow'></i>
                    </a>
                    <a href={profile[0].instagramlink} className='pl-4'>
          ...
          <div className='container flex flex-col items-center py-16 md:py-20 lg:flex-row'>
            <div className='w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left'>
              ...
              <h4 className='pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl'>
                I'm {profile[0].name}, a Web Designer & Photographer
              </h4>
